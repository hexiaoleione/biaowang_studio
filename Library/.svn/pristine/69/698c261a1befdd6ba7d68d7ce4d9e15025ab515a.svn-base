...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		mDoneButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				tryVibrate();
				if (mCallBack != null) {
					String month = mSelectedMonthTextView.getText().toString();
					mCallBack.onDateSet(DatePickerDialog.this,mYearView.getText().toString(),
							month.substring(0, month.length()-1), mSelectedDayTextView.getText().toString(),mCalendar);
                }
                dismiss();
			}
		});
	...
	public static abstract interface OnDateSetListener {
		public abstract void onDateSet(DatePickerDialog datePickerDialog, String year, String month, String day,Calendar mcalander);
	}
}