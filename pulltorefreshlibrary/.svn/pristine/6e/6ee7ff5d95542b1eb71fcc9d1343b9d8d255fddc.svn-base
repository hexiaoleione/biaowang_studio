...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public void setNoMoreView(View noMoreView) {
		...
		getRefreshableView().addFooterView(noMoreView, null, false);
	...
	private boolean showNoreMore() {
		return getRefreshableView().getAdapter() != null 
				&& getRefreshableView().getAdapter().getCount() > 0 && getMode() == Mode.PULL_FROM_START;
	}
