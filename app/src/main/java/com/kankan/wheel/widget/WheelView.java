...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_vardaletou);
		}
		...
		//设置滚动框的颜色
		setBackgroundResource(R.drawable.wheel_bgdaletou);
	}
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT / 200;
