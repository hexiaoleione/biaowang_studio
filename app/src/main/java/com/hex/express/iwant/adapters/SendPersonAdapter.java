...
public class SendPersonAdapter extends BaseListAdapter {
	private RelativeLayout rl;
	public SendPersonAdapter(Context context, List list) {
		super(context, list);
	}
	public SendPersonAdapter(Context context,List list,RelativeLayout rl){
		super(context, list);
		this.rl=rl;
	}
...
//		@Bind(R.id.tv_mydefault) TextView tv_mydefault;
		...
		public void setData(final int position) {
			...
			tv_default_edit.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					//AsyncHttpUtils.doPut(context, url, json, params, responseHandler)c
...
//			}
	...
	public int getLayoutResource() {
		// TODO Auto-generated method stub
		return R.layout.item_sendperson;
	}
