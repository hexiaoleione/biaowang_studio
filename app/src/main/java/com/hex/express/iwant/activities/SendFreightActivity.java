...
import com.hex.express.iwant.fragments.SendEscortWayFragment;
 ...
 * 
 */
public class SendFreightActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ButterKnife.bind(SendFreightActivity.this);
		initData();
	}
	...
	public void initData() {
		...
		dialog = new LoadingProgressDialog(SendFreightActivity.this);
