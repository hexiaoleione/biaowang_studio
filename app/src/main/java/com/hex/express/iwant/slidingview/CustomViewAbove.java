package com.hex.express.iwant.slidingview;

import java.util.ArrayList;
import java.util.List;

import com.hex.express.iwant.slidingview.SlidingMenu.OnClosedListener;
import com.hex.express.iwant.slidingview.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private static final int MAX_SETTLE_DURATION = 100; // ms
	...
	protected int mTouchMode = SlidingMenu.TOUCHMODE_MARGIN;//TOUCHMODE_MARGIN TOUCHMODE_MARGIN
  ...
  //侧滑控制
	private boolean thisTouchAllowed(MotionEvent ev) {
		...
		if (isMenuOpen()) {
			...
			switch (mTouchMode) {
			case SlidingMenu.TOUCHMODE_FULLSCREEN:// TOUCHMODE_FULLSCREEN
				return !isInIgnoredView(ev);
			case SlidingMenu.TOUCHMODE_NONE:// TOUCHMODE_NONE
				return false;
			case SlidingMenu.TOUCHMODE_MARGIN:// TOUCHMODE_MARGIN
