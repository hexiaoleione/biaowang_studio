...
public class ProvCityTownAcrivity extends Activity{
	...
	private ProvincetownAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_provcity);
	...
	private void initProvince(){
		...
		adapter = new ProvincetownAdapter(ProvCityTownAcrivity.this,resultPro);
		ProvCityTownAcrivity.this.provList.setAdapter(adapter);
	}
...
//				adapter.setSelectItem(index);
		...
		adapter = new ProvincetownAdapter(ProvCityTownAcrivity.this,resultCity);
		ProvCityTownAcrivity.this.cityList.setAdapter(adapter);
	}
...
//				intent.putStringArrayListExtra("area", back);
		...
		adapter = new ProvincetownAdapter(ProvCityTownAcrivity.this,resultTown);
		ProvCityTownAcrivity.this.townList.setAdapter(adapter);
	}
