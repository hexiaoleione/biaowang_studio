...
public List<Data> data = new ArrayList<Data>();
	...
	public class Data{
		public int recId;//主键
		 ...
		 public String personName;//收货人姓名
		 ...
		 public String driverName;    //用户对(司机/公司)评价分数
		 public String matName;   //用户对(司机/公司)评价内容
		 public String mobile;       //(司机/公司)标签
