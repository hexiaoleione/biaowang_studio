 ...
 * @author huyichuan
 */
public class MinPagerAdaptersew extends FragmentStatePagerAdapter {
	...
	public MinPagerAdaptersew(FragmentManager fm) {
		super(fm);
		// TODO Auto-generated constructor stub
	}

	private final String[] titles = {"MinFragment1", "MinFragment2", "MinFragment4" };
