 ...
 *  我的关注
 */
public class LoistcalConcernActivity extends BaseActivity{
		...
		AsyncHttpUtils.doGet(UrlMap.getThreeUrl(MCUrl.COUPON, "userId", String
				...
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						if (isFirst) {
							if (mList.size() != 0 && mList != null) {
								if (adapter == null) {
									adapter = new ConcerAdapter(
											LoistcalConcernActivity.this, mList);
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
							Throwable arg3) {
						dialog.dismiss();
						ToastUtil.shortToast(LoistcalConcernActivity.this, "网络请求加载失败");
