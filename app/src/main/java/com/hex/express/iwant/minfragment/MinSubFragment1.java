...
public class MinSubFragment1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (view==null) {
			view=inflater.inflate(R.layout.fragment_min1, container, false);
		}
...
// 	    ToastUtil.shortToast(getActivity(), "手机型号"+string);
		return view;
	}
	...
	/**
	 * 获取网络数据  getTaskByType  downwindTaskRouteListType
	 */
...
//				re_layou.setOnLongClickListener(new OnLongClickListener() {
//					
//					@Override
//					public boolean onLongClick(View arg0) {
//						// TODO Auto-generated method stub
//						if (bean.data.get(position).status.equals("4") ||bean.data.get(position).status.equals("5") || bean.data.get(position).status.equals("7") || bean.data.get(position).status.equals("8")) {
