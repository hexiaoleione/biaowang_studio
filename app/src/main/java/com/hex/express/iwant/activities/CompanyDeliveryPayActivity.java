...
import com.hex.express.iwant.mypasspay.PasswordView;
...
public class CompanyDeliveryPayActivity extends Activity {
...
//		 });
	...
	private void PostHttpRequst() {
		...
		if (!strPassword.equals(PreferencesUtils.getString(
			...
			AsyncHttpUtils.doPostJson(CompanyDeliveryPayActivity.this, MCUrl.WITHDRAW,
						...
						public void onSuccess(int arg0, Header[] arg1,
							...
							if (bean.isSuccess()) {							
								Builder ad = new Builder(
										CompanyDeliveryPayActivity.this);
								ad.setTitle("温馨提示");
								ad.setMessage("成功");
...
//																"成功");
								...
								ToastUtil.shortToast(CompanyDeliveryPayActivity.this,
										bean.getMessage());
							}
						}
