...
import com.hex.express.iwant.adapters.PoiAdapter;
import com.hex.express.iwant.adapters.PoiSearchAdapter;

import java.util.List;

public class BduActivity extends Activity implements BDLocationListener, OnGetGeoCoderResultListener, BaiduMap.OnMapStatusChangeListener, TextWatcher {

    private MapView mMapView;
    private BaiduMap mBaiduMap;
    private ListView poisLL;
    private TextView addse;
    /**
     * 定位模式
     */
...
//    private MKSearch mMKSearch;
    ...
    private void initView() {
        ...
        addse= (TextView) findViewById(R.id.addse);
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
        ...
        if (poiInfos.size()>0) {
        	  addse.setText(""+poiInfos.get(0).address.toString());
		}
      
        PoiAdapter poiAdapter = new PoiAdapter(BduActivity.this, poiInfos);
        ...
        if (s.length() == 0 || "".equals(s.toString())) {
            ...
            poiSearch.setOnGetPoiSearchResultListener(new OnGetPoiSearchResultListener() {
                ...
                public void onGetPoiResult(PoiResult poiResult) {
                    ...
                    PoiSearchAdapter poiSearchAdapter = new PoiSearchAdapter(BduActivity.this, poiInfos, locationLatLng);
//                    geoCoder.reverseGeoCode(new ReverseGeoCodeOption().location(locationLatLng));
