 ...
 */
public class CardActivityse extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cardse);
...
//		tbv_show.setTitleText(R.string.cardtitle);
		...
		btnRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				startActivity(new Intent(CardActivityse.this, HModelActivity.class));
			}
		});
	}
		...
		AsyncHttpUtils.doGet(UrlMap.getThreeUrl(MCUrl.COUPON, "userId", String
				...
				new AsyncHttpResponseHandler() {
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
							Throwable arg3) {
						dialog.dismiss();
						ToastUtil.shortToast(CardActivityse.this, "网络请求加载失败");
...
//				if (getIntent().getIntExtra("type", 0)==data.couponId) {
					if (data.money != 0 && data.userCouponId != 0) {
						intent.setClass(CardActivityse.this, DownWindPayActivity.class);
