...
public class DepotActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ButterKnife.bind(DepotActivity.this);
		initView();
		initData();
		setOnClick();
	}
...
@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	public void setOnClick() {
		...
		btn_poset.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(DepotActivity.this, DepotAddsActivity.class);
...
//		});
	...
	private void getHttpRequst(final boolean isFirst, final boolean isRefresh,
		...
		String url = UrlMap.getThreeUrl(MCUrl.LogComAddList, "userId",String.valueOf(PreferencesUtils.getInt(DepotActivity.this, PreferenceConstants.UID)),
...
//					ToastUtil.shortToast(LogistcaInforseActivity.this, ""+bean.message);
				...
				if (isFirst) {
					if (mList.size() != 0 && mList != null) {
						if (adapter == null) {
							mList2.addAll(mList);
							adapter = new DepotAdapter(DepotActivity.this,
									mList2);
					...
					if (isRefresh && !isPull) {
						...
						if (mList.size() != 0 && mList != null) {
							depot_listview.onRefreshComplete();
								adapter = new DepotAdapter(DepotActivity.this, mList);
								listView.setAdapter(adapter);
...
//				getHttpRequst(true, false, 1, false);
   ...
   private void addmesge(){
	   JSONObject obj = new JSONObject();
		...
		AsyncHttpUtils.doPostJson(DepotActivity.this, MCUrl.AddComAdd, obj.toString(),
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						if (bean.getErrCode() == 0) {
							...
							ToastUtil.shortToast(DepotActivity.this, bean.getMessage());
						}
   ...
   private void revisemesge(){
	   JSONObject obj = new JSONObject();
		...
		AsyncHttpUtils.doPostJson(DepotActivity.this, MCUrl.UpdateComAdd, obj.toString(),
				new AsyncHttpResponseHandler() {
