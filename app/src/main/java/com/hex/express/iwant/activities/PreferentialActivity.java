...
//		webView.loadUrl("http://www.efamax.com/mobile/userWalletHelp.html ");//普通用户的现金政策；
		webView.loadUrl("http://www.efamax.com/mobile/weixin/Attract_investment.html ");//普通用户的代理政策；
