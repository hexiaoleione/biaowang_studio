package com.hex.express.iwant.iflytek;
...
//		setContentView(R.layout.ttsdemo);
		  SpeechUtility.createUtility(getApplication(), "appid=" + "59acb492");
//		initLayout();
		// 初始化合成对象
...
//		mCloudVoicersValue = getResources().getStringArray(R.array.voicer_cloud_values);
		...
		setParam();
		 mTts.startSpeaking(getIntent().getStringExtra("message"), mTtsListener);
//		/** 
...
//			// 设置参数
//			setParam();
//			int code = mTts.startSpeaking(getIntent().getStringExtra("message"), mTtsListener);
////			/** 
////			 * 只保存音频不进行播放接口,调用此接口请注释startSpeaking接口
////			 * text:要合成的文本，uri:需要保存的音频全路径，listener:回调接口
////			*/
