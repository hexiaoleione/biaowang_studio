...
import com.hex.express.iwant.adapters.MylisAdapter;
import com.hex.express.iwant.adapters.MylisQuotAdapter;
...
public class LogisticalQuoteActivity extends BaseActivity{

	@Bind(R.id.quotu_listview)
	PullToRefreshListView quotu_listview;
	@Bind(R.id.quotu_show)
	TitleBarView quotu_show;
	private ListView listView;
	protected int pageSize = 10;// 表示一页展示多少列
	protected int pageNo = 1;
	private List<CardBean.Data> mList;
	private MylisQuotAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_quot_logistical);
		ButterKnife.bind(LogisticalQuoteActivity.this);
		initView();
		initData();
		setOnClick();
		getData();
	...
	public void initView() {
		// TODO Auto-generated method stub
		quotu_show.setTitleText("我的物流");
		listView = quotu_listview.getRefreshableView();
...
//		getHttprequst(true, false, 1, false);
		...
		AsyncHttpUtils.doGet(UrlMap.getThreeUrl(MCUrl.COUPON, "userId", String
				...
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						if (isFirst) {
							if (mList.size() != 0 && mList != null) {
								if (adapter == null) {
									adapter = new MylisQuotAdapter(
											LogisticalQuoteActivity.this, mList);
									listView.setAdapter(adapter);
								}
							} else {
								quotu_listview.setVisibility(View.GONE);
							}
						} else {
							if (isRefresh && !isPull) {
								adapter.setData(mList);
								adapter.notifyDataSetChanged();
								quotu_listview.onRefreshComplete();
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
							Throwable arg3) {
						dialog.dismiss();
						ToastUtil.shortToast(LogisticalQuoteActivity.this, "网络请求加载失败");
	...
	public void setOnClick() {
		...
		// 下拉刷新与上拉加载
		quotu_listview.setMode(Mode.BOTH);
		quotu_listview.setOnRefreshListener(new OnRefreshListener2() {
		...
		quotu_listview.setOnItemClickListener(new OnItemClickListener() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				//第一个
//				Intent intent = new Intent(LogisticalQuoteActivity.this, LogisticalParticulars.class);
				//第二个
				Intent intent = new Intent(LogisticalQuoteActivity.this, MydetailedActivity.class);
