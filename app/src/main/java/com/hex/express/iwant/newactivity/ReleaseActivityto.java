...
public class ReleaseActivityto extends BaseActivity {
...
//	EditText et_gao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.release_activityto);
    ...
    private void getrequstBalance() {
        ...
        AsyncHttpUtils.doGet(
                UrlMap.getUrl(MCUrl.BALANCE, "id",
                        String.valueOf(PreferencesUtils.getInt(ReleaseActivityto.this, PreferenceConstants.UID))),
...
//							}
    ...
    public void initView() {
        // TODO Auto-generated method stub
//		pvTime.show();
        client = new LocationClient(ReleaseActivityto.this);
        initLocation();
        client.registerLocationListener(new BDLocationListener() {
            ...
            public void onReceiveLocation(BDLocation arg0) {
                if (arg0 == null) {
                    ToastUtil.shortToast(ReleaseActivityto.this, "定位失败，请检查设置");
                    latitude = 0.0;
                    longitude = 0.0;
                    return;
                } else {
...
//		ToastUtil.longToast(ReleaseActivity.this, "fromLongitude"+fromLongitude);
    ...
    public void initData() {
        ...
        tv_modifySenderAddress.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                startActivityForResult(new Intent(ReleaseActivityto.this, LocationDemo.class), 15);
...
//				intent.putExtra("high", et_gao.getText().toString());
                ...
                intent.setClass(ReleaseActivityto.this, LogisewindActivity.class);
...
//				intent.putExtra("high", et_gao.getText().toString());
                ...
                intent.putExtra("carType", carbeans.data.get(cars).carType);
                intent.putExtra("matVolume", carbeans.data.get(cars).carName);
                intent.setClass(ReleaseActivityto.this, LogisewindtimlitActivity.class);
//				startActivity(intent);
...
//				intent.putExtra("high", et_gao.getText().toString());
                ...
                intent.setClass(ReleaseActivityto.this, LoginseticsActivity.class);
//				startActivity(intent);
...
//				fromLongitude=getIntent().getDoubleExtra("fromLongitude", 0.0);
                    if ("".equals(et_address.getText().toString()) || "".equals(ftownCode)
                        ...
                        ToastUtil.shortToast(ReleaseActivityto.this, "发件地位置不准确");
                        return;
                    }
...
//					obj.put("addressTo", et_address.getText().toString());
                        ...
                        intent.putExtra("toLongitude", receiver_longitude);
                        intent.putExtra("nochangedi", "1");
                        intent.putExtra("matWeight", sunmit(1, kes));//重量
                        if (zhongge == 0) {
                            intent.putExtra("matWeightdan", "吨");//重量
                        } else {
                            intent.putExtra("matWeightdan", "公斤");//重量
                        }
                        intent.putExtra("nochange", "1");
//					intent.putExtra("length", et_chang.getText().toString());// length
//					intent.putExtra("wide", et_kuan.getText().toString());
...
//					intent.setClass(ReleaseActivity.this, LoginseticsActivity.class);
                        intent.setClass(ReleaseActivityto.this, LoginseticsActivityto.class);
                        startActivityForResult(intent, 12);
                    } else {
//					addPostResult();
                        Intent intent = new Intent();
...
//						startActivity(intent);
                    ...
                    if (et_time.getText().toString().equals("")
                        ...
                        ToastUtil.shortToast(ReleaseActivityto.this, "时间未选择");
                        return;
                    }
                    Intent intent = new Intent();
...
//				submit.setVisibility(View.VISIBLE);
                ...
                View view = View.inflate(ReleaseActivityto.this, R.layout.dialog_select_time, null);
...
//				pw.showAtLocation(Rl_all, 0, 0,  Gravity.END);
                ...
                pw.showAtLocation(ReleaseActivityto.this.findViewById(R.id.fanshi), Gravity.END, 1, 1);
...
//	                        		  System.out.println(""+days+"天"+hours+"小时"+minutes+"分");
                                    if (hours <= 0) {
                                        ToastUtil.shortToast(ReleaseActivityto.this, "不能选择过去的时间\n请重新选择。");
                                        et_time.setText("");
//	                            	 return;
                                    } else {
...
//		}
        ...
        final String[] myItems = getResources().getStringArray(
                R.array.zhong);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(ReleaseActivityto.this,
...
//		data_list1.add("5公斤及以下");
        ...
        final String[] myItems1 = getResources().getStringArray(
                R.array.jianshu);
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(ReleaseActivityto.this,
...
//				Log.e("11111", "position"+sunmit(5, position));
        ...
        // 时间选择器
        pvTime = new TimePickerView(ReleaseActivityto.this, TimePickerView.Type.MONTH_DAY_HOUR_MIN);
        // 控制时间范围
...
//				}
    ...
    public void Cartype() {
        ...
        AsyncHttpUtils.doSimGet(MCUrl.getCagoType, new AsyncHttpResponseHandler() {
            @Override
            public void onFailure(int arg0, Header[] arg1, byte[] arg2, Throwable arg3) {
...
//		Log.e("1111111size   ",carbeans.data.size()+"");
        for (int i = 0; i < carbeans.getData().size(); i++) {
            data_list11.add(carbeans.data.get(i).cagoType);
        }
...
//		ToastUtil.shortToast(ReleaseActivity.this, data_list11.size()+"");
        final String[] myItems11 = getResources().getStringArray(
                R.array.huoz);
        ArrayAdapter<Object> adapter11 = new ArrayAdapter<Object>(ReleaseActivityto.this,
...
//		startActivity(new Intent(getActivity(), H5ModelActivity.class));
                startActivityForResult(new Intent(ReleaseActivityto.this, LocationDemo.class), 8);
                submit.setVisibility(View.VISIBLE);
                sa.setVisibility(View.GONE);
                te_juli.setVisibility(View.GONE);
                fanshi.setVisibility(View.GONE);
...
//		   return dateFormat.format(now);
    ...
    private void addPostResult() {
        ...
        if (et_add_address.getText().toString().equals("") || receiver_citycode.equals("")) {
            ToastUtil.shortToast(ReleaseActivityto.this, "请重新选择收件地址信息");
            return;
        }
        try {
            obj.put("userId",
...
//			obj.put("addressTo", et_address.getText().toString());
            ...
            obj.put("matWeight", sunmit(1, kes));//重量
...
//			obj.put("length", ""+et_gao.getText().toString());
            ...
            obj.put("publshDeviceId", DataTools.getDeviceId(ReleaseActivityto.this));
...
//		ToastUtil.longToast(ReleaseActivity.this, obj.toString());
        AsyncHttpUtils.doPostJson(ReleaseActivityto.this, MCUrl.getPriceByType, obj.toString(),
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        dialog.dismiss();
                        ReleaseBean bean = new Gson().fromJson(new String(arg2), ReleaseBean.class);
                        if (bean.getErrCode() == 0) {
                            submit.setVisibility(View.GONE);
                            Logger.e("1111111oppop", bean.data.toString());
                            text_mshun.setText(bean.data.get(0).dowPrice);
                            text_mxian.setText(bean.data.get(0).limitPrice);
                            text_mwuliu.setText("" + bean.data.get(0).logisPrice);
                            if (bean.data.get(0).showType.equals("1")) {
                                sa.setVisibility(View.VISIBLE);
                                zhiyouwuliu.setVisibility(View.GONE);
                                te_juli.setVisibility(View.VISIBLE);
                                fanshi.setVisibility(View.GONE);
                                DecimalFormat df = new DecimalFormat("######0.00");
                                te_juli.setText("运送总距离：" + df.format(bean.data.get(0).distance) + "公里");
                            } else {
                                if (bean.data.get(0).showType.equals("2")) {
                                    zhiyouwuliu.setVisibility(View.VISIBLE);
                                    sa.setVisibility(View.GONE);
                                } else {
                                    sa.setVisibility(View.GONE);
