...
public class RecevierListActivity extends BaseActivity {
		...
		AsyncHttpUtils.doSimGet(UrlMap.getUrl(MCUrl.RECEIVER_LIST, "userId", PreferencesUtils.getInt(getApplicationContext(), PreferenceConstants.UID)+""), new AsyncHttpResponseHandler() {
			...
			//	Log.e("list",bean.data.get(0).cityCode);
				...
				if(list!=null&&list.size()!=0){
					adapter=new ReceiverAdapter(RecevierListActivity.this, list,rl_add);
	...
	public void add(View view){
		switch (view.getId()) {
		case R.id.btn_add:
			startActivity(new Intent(RecevierListActivity.this,AddReceiverActivity.class));
			break;
