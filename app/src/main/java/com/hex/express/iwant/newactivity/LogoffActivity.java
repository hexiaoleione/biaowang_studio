...
public class LogoffActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mylog);//activity_mylogisti
		iWantApplication.getInstance().addActivity(this);
		ButterKnife.bind(LogoffActivity.this);
		initView();
		setOnClick();
		getData();
	}
...
//		deta_fahuotime.setText("发货时间："+loff.getData().get(0).takeTime);
		...
		deta_agin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(LogoffActivity.this, ReleaseActivity.class);
