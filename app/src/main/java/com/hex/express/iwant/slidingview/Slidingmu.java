...
public class Slidingmu extends RelativeLayout {
	...
	public Slidingmu(Context context) {
		super(context);
		init(context);
	}
	...
	public boolean gethasClickLeft(){
		return hasClickLeft;
	}

	public Slidingmu(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public Slidingmu(Context context, AttributeSet attrs, int defStyle) {
