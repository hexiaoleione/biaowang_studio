 ...
 * û������
 */
public class MinPagerAdaptersewk extends FragmentStatePagerAdapter {
	...
	public MinPagerAdaptersewk(FragmentManager fm) {
		super(fm);
		// TODO Auto-generated constructor stub
	}
	//TODO 	修改乱码title
	private final String[] titles = {  "MinFragment1","MinFragment2" };
