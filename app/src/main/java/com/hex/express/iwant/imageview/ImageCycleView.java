package com.hex.express.iwant.imageview;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 图片轮播视图
	 */
	private CycleViewPagers mBannerPager = null;
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		mBannerPager = (CycleViewPagers) findViewById(R.id.pager_banner);
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			index -= 1;
			mImageViews[index].setBackgroundResource(R.drawable.icon_point_prese);
			for (int i = 0; i < mImageViews.length; i++) {
				if (index != i) {
					mImageViews[i].setBackgroundResource(R.drawable.icon_pointse);//icon_point_prese  icon_pointse
				}
			}
