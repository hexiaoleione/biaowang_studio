...
public class MoreAddressActivity extends Activity implements OnClickListener, OnGetSuggestionResultListener,
	...
	class PoiAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(context).inflate(R.layout.locationpois_itemse, null);
			...
			if (position == 0) {
				holder.iv_gps.setImageDrawable(getResources().getDrawable(R.drawable.dingwei_bar));
			...
			if (position == 0 && linearLayout.getChildCount() < 2) {
				...
				imageView.setImageResource(R.drawable.dingwei_bar);
