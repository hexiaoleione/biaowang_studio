...
public class ProvCityActivity extends Activity{
	...
	private void initProvince(){
		...
		adapter = new ProvinceAdapter(ProvCityActivity.this,resultPro);
		ProvCityActivity.this.provList.setAdapter(adapter);
	}
	...
	private void initCity(String provCode){
		...
		adapter = new ProvinceAdapter(ProvCityActivity.this,resultCity);
		ProvCityActivity.this.cityList.setAdapter(adapter);
	}
...
//				intent.putStringArrayListExtra("area", back);
				...
				ProvCityActivity.this.setResult(RESULT_OK, intent);
				finish();
			}
		});
		resultTown = getTownData(cityCode);
		adapter = new ProvinceAdapter(ProvCityActivity.this,resultTown);
		ProvCityActivity.this.townList.setAdapter(adapter);
	}
