...
import com.hex.express.iwant.adpter.MinPagerAdapterkj;
 ...
 *  接镖
 */
public class PickToActivity extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ButterKnife.bind(PickToActivity.this);
	...
	public void initView() {
		// TODO Auto-generated method stub
//		if (isLogin()) {
//			if (PreferencesUtils.getString(PickToActivity.this, PreferenceConstants.WLID).equals("0") || PreferencesUtils.getString(PickToActivity.this, PreferenceConstants.WLID).equals("")){
//				pager.setAdapter(new MinPagerAdapterkj(this.getSupportFragmentManager()));
//			}else {
//				pager.setAdapter(new MinPagerAdapterse(this.getSupportFragmentManager()));
//			
//			}
				pager.setAdapter(new MinPagerAdapterse(this.getSupportFragmentManager()));
...
//		tabs.setSelectedTextColor(Color.parseColor("#FF730A"));// #45c01a
	...
	public boolean isLogin(){
		return PreferencesUtils.getBoolean(PickToActivity.this, PreferenceConstants.ISLOGIN);
		}
