 ...
 *
 */
public class DownWindTimeLimitedActivity extends BaseActivity {
	...
	public void initData() {
		myLatitude = getIntent().getDoubleExtra("latitude", 0.0);
		myLongitude = getIntent().getDoubleExtra("longitude", 0.0);
...
//		}else {
		btn_postDownwindTask.setText("我要发件");
			first = true;
			text_title.setText("限时专递");
			lout2.setBackgroundResource(R.drawable.banner_nearby); 
	...
	public void MyonClick(View view) {
		...
		case R.id.escort:// 我是镖师
			if (PreferencesUtils.getString(getApplicationContext(), PreferenceConstants.USERTYPE).equals("1")) {
				Builder ad = new Builder(DownWindTimeLimitedActivity.this);
				ad.setTitle("温馨提示");
				ad.setMessage("您未认证镖师，没权限查看");
				ad.setPositiveButton("确认", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface arg0, int arg1) {
						startActivity(new Intent(DownWindTimeLimitedActivity.this, PrefectActivity.class).putExtra("IDENTIFY_CODE",
								"2"));
					}
				});
...
//			}
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (isFirst) {
					if (mList.size() != 0 && mList != null) {
						adapter = new DownwindOwnerAdapter(DownWindTimeLimitedActivity.this, mList);
	...
	private void getHttpOwnerRequst(final boolean isFirst, final boolean isRefresh, int escorePageNo,
		...
		String url = UrlMap.getfour(MCUrl.DOWNWINDTASKLIMITTIME, "userId",
				String.valueOf(PreferencesUtils.getInt(getApplicationContext(), PreferenceConstants.UID)), "pageNo",
				String.valueOf(escorePageNo), "pageSize", String.valueOf(pageSize), "sortType", sortType);
		dialog.show();
		Log.e("111111jdkj", url);
		AsyncHttpUtils.doSimGet(url, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				escoreList2.clear();
				...
				if (isFirst) {
					if (escoreList.size() != 0 && escoreList != null) {
						...
						escoreAdapter = new DownwindEscortAdapter(DownWindTimeLimitedActivity.this, escoreList);
...
//				ToastUtil.longToast(getApplicationContext(), "经纬___"+myLatitude+myLongitude);
//				intent.setClass(DownWindTimeLimitedActivity.this, PostLimitedDownwindTaskActivity.class);
...
//				getHttpOwnerRequst(true, false, 1, false, sortType);
		...
		escoreListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				{
//					AlertDialog.Builder ad = new Builder(DownWindTimeLimitedActivity.this);
//					ad.setTitle("温馨提示");
//					ad.setMessage("您还不是镖师需要认证后才能接单");
//					ad.setNegativeButton("去认证", new DialogInterface.OnClickListener() {
//
//						@Override
//						public void onClick(DialogInterface arg0, int arg1) {
//							Intent intent=new Intent();
//							intent.setClass(DownWindTimeLimitedActivity.this, RoleAuthenticationActivity.class);
//							startActivity(intent);
//						}
//					});
...
//					ad.create().show();
				...
				Intent intent = new Intent(DownWindTimeLimitedActivity.this, DownEscortDetialsActivity.class);
...
//				intent.putExtra("transferMoney", String.valueOf(data.transferMoney));
	...
	private void showPaywindow() {
		...
		// 在底部显示
		window02.showAtLocation(DownWindTimeLimitedActivity.this.findViewById(R.id.btn_escort), Gravity.CENTER, 0, 0);
